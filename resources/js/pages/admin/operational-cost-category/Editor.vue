...
const page = usePage();
const title = (!!page.props.data.id ? "Edit" : "Tambah") + " Kategori Biaya Operasional";
        ...
        <q-form class="row" @submit.prevent="submit" @validation-error="scrollToFirstErrorField">
          <q-card square flat bordered class="col">
            <q-card-section class="q-pt-none">
              ...
              <q-input autofocus v-model.trim="form.name" label="Deskripsi" lazy-rules :error="!!form.errors.name"
